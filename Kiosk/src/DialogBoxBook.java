 ...
 */
public class DialogBoxBook extends Dialog<Newspaper>
{
            ...
            public Book call(ButtonType button) {
                ...
                if (button == ButtonType.OK) {
                    ...
                    if (mode == Mode.NEW) {
                        ...
                        existingBook.setEdition(edition.getText());
                        existingBook.setGenre(genre.getText());
                        existingBook.setRefNumber(refNumber.getText());
                        existingBook.setReleaseDate(releaseDate.getText());
                        existingBook.setPages(pagesNo);
                        existingBook.setPrice(priceInt);
                        result = existingBook;
                    }
                    return result;
                }
